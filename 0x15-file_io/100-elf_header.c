...
/**
 * main - This main function displays the information
 * contained in the ELF file.
 *
...
/**
 * print_data - This functuion prints the data of an ELF header.
 *
